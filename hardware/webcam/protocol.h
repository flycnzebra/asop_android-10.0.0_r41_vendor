...
const static u_char PC_START_PLAY[22] = {
...
//数据	x	byte	音频数据
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char PC_PLAY_DATA[20] = {
...
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char PC_PAUSE_PLAY[16] = {
...
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char PC_STOP_PLAY[16] = {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x02,
...
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char PC_OPEN_SPEAK[24] = {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x14, 0x00, 0x02,
...
//数据	x	byte	音频数据
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char PC_SPEAK_DATA[20] = {
...
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char PC_CLOSE_SPEAK[16] = {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x02,
...
//结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
//音频录制接口
const static u_char PC_REPLAY_DATA[16] =  {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x02,
    ...
    //结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char OPEN_CAMERA[22] = {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x14, 0x00, 0x02,
    ...
    //预留字节	4字节	Unsigned Integer    预留字节
    //结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char CLOSE_CAMERA[16] = {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x14, 0x00, 0x02,
    ...
    //结束符号	2字节	Unsigned Integer	固定的结束符号0x7e0d
const static u_char VIDEO_DATA[30] = {
            0x7e, 0xa5, 0x00, 0x00, 0x00, 0x14, 0x00, 0x02,
