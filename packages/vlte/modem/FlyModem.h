//
// Created by FlyZebra on 2020/8/11 0011.
//

#ifndef ANDROID_FLYMODEM_H
#define ANDROID_FLYMODEM_H
...
public:
    ...
    ~FlyModem(){}
private:
static const int AT_NUM = 68;
static const char* AT_CMD[][2] = {
    {"ATE0Q0V1","OK\n"},
    {"AT+CTEC?","+CTEC: 0,f\nOK\n"},
    ...
    {"AT+CMGF=0","OK\n"},
    {"AT+CFUN?","+CFUN: 0\nOK\n"},
    {"AT+CGSN","310260161369296\nOK\n"},
    {"AT+CFUN=1","OK\n"},
    {"AT+COPS=3,0;+COPS?;+COPS=3,1;+COPS?;+COPS=3,2;+COPS?","+COPS: 0,0,\"T-Mobile\"\n+COPS: 0,1,\"T-Mobile\"\n+COPS: 0,2,\"310260\"\nOK\n"},
    {"AT+CGREG?","+CGREG: 1,1,\"0003\",\"005b\",\"000e\"\nOK\n"},
    {"AT+CREG?","+CREG: 2,1, \"0003\", \"005b\"\nOK\n"},
    {"AT+COPS?","+COPS: 0,2,310260\nOK\n"},
    ...
    {"AT+CRSM=176,28436,0,0,20","+CRSM: 144,0,542d4d6f626c6965ffffffffffffffffffffffff\nOK\n"},
